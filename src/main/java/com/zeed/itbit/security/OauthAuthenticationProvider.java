...
import com.zeed.itbit.security.exception.ITunesAuthenticationException;
import com.zeed.itbit.security.providers.UserAuthenticationProvider;
...
public class OauthAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        List<com.zeed.itbit.security.AuthenticationProvider> authenticationProviders = new ArrayList<>();
        authenticationProviders.add(userAuthenticationProvider);

        for (com.zeed.itbit.security.AuthenticationProvider authenticationProvider:authenticationProviders) {
